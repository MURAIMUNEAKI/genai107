<?php
// app27.php - 特別支援向け教材変換 Geminiプロキシ（同期JSON・ファイルテキスト抽出対応）
...
$systemPrompt = getSystemPrompt(27);
if ($systemPrompt === '') $systemPrompt = '特別支援教育の専門家として、教材を児童・生徒の特性に合わせてわかりやすく変換してください。';
