<?php
// app116.php - 校内研修企画・運営計画 Geminiプロキシ（同期JSON・マルチターン対応）
...
$systemPrompt = getSystemPrompt(116);
if ($systemPrompt === '') $systemPrompt = '校内研修の企画と運営計画を、目的・対象・内容・スケジュールを含めて作成してください。';
