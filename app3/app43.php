<?php
// app43.php - 穴埋め・一問一答自動生成 Geminiプロキシ（同期JSON・ファイルテキスト抽出対応）
...
$systemPrompt = getSystemPrompt(43);
if ($systemPrompt === '') $systemPrompt = 'ユーザーが【形式】で指定した形式（穴埋め問題、一問一答、正誤問題、混合）に従って問題を生成してください。指定された形式のみを出力し、他の形式は混ぜないでください。';
