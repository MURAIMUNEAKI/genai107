<?php
// app54.php - 作文・小論文添削アシスタント Geminiプロキシ（同期JSON・ファイルテキスト抽出対応）
...
$systemPrompt = getSystemPrompt(54);
if ($systemPrompt === '') $systemPrompt = '作文・小論文を添削し、構成・表現・論理展開について具体的な改善点を提示してください。';
